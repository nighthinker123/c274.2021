...
from ooclassifier_batch import *
...
def main():
    ...
    ts_2 = tset.return_nfolds(4)

    print("**** Fold 0 ********************************")
    run1.classify_all(ts_2[2])
    run1.print_config()
    run1.eval_training_set(ts_2[2], plabel, lines=False)
    run1.print_pra()

    print("**** Fold 1 ********************************")
    run1.classify_all(ts_2[3])
    run1.print_config()
    run1.eval_training_set(ts_2[3], plabel, lines=False)
    run1.print_pra()
