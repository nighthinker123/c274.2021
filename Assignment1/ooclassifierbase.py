...
class TrainingInstance(C274):
    ...
    def process(sent : list, mode : str) -> str:
        processedWords = []
        ...
        processedWords = filter(None, processedWords)
